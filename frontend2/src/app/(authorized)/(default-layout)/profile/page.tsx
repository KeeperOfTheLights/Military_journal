...
import { z } from 'zod';
import { useChangePasswordApiAuthChangePasswordPost } from '@/api/orval/client/authentication/authentication';
import { useGetMyStudentProfileApiStudentsMeProfileGet } from '@/api/orval/client/students/students';
import { useGetMyTeacherProfileApiTeachersMeProfileGet } from '@/api/orval/client/teachers/teachers';
