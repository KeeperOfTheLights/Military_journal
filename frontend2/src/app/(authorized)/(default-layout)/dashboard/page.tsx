...
import { useGetDashboardStatsApiAnalyticsDashboardGet } from '@/api/orval/client/analytics/analytics';
import { useGetMyScheduleApiScheduleMyGet } from '@/api/orval/client/schedule/schedule';
import {
  Users,
  GraduationCap,
  BookOpen,
